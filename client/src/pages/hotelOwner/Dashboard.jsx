...
const Dashboard = () => {
  ...
  return (
    <div>
        <Title align='left' font='font-outfit' title='Dashboard' subTitle='Monitor your room listings, track bookings, and analyse revenue-all in one place. Stay updated with real-time insights  to ensure smooth operations. '/>
