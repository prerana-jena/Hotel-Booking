...
const ListRoom = () => {
  ...
  return (
    <div>
      <Title align='left' font='outfit' title='Room Listings' subTitle='View, Edit, or manage all listed rooms. Keep information up-to-date to provide best experience for users.'/>
      <p className='text-gray-500 mt-8'>All Rooms
      </p>
